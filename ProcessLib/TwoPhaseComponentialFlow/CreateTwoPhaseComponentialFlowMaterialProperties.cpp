    ...
    namespace TwoPhaseComponentialFlow
    {
                ...
                std::vector<std::unique_ptr<ParameterBase>> const& parameters)
        {
            ...
            for (auto const& conf : poro_config.getConfigSubtreeList("porous_medium"))
            {
                ...
                auto n = MaterialLib::PorousMedium::createPorosityModel(porosity_conf, parameters);
            ...
            return std::unique_ptr<TwoPhaseComponentialFlowMaterialProperties>{
                new TwoPhaseComponentialFlowMaterialProperties{
